...
### Task:
Improve the docs. For that traverse the codebase and read relevant files for the documentation topic of the targeted documentation file carefully and understand the core concepts first before re-thinking the existing documentation. Then craft your additions and edits.

### Rules:
- Be concise in format, professional in tone, 3rd person perspective writing
- Avoid chatter, prose, humor, repitition
- Audience is a professional. Beginner friendly entry points with examples and pointers, but should progress as information dense and signal rich for professionals.
- Also include short paragraphs instead of adding only bullet point structures for a good mix
- Dont mention too much of the code directly, instead only the most characteristic pieces
- Focus most on what it means, how to use it, tips and gotchas, patterns instead of code pieces
- Think in minimal diffs as possible for an editor to better reason through instead of too eagerly rewriting everything

### Goals:
- The goal of the documentation is to educate all team disciplines, not just tech users, about the big picture, architecture, use cases
- Also to guide them through getting started with sufficient background context
- Capture patterns, inputs/outputs, best practices, tips and gotchas, etc.
- Provide code-file references for maintainers to navigate the codebase faster or learners to read further.

### Visuals
Propose where we can add visual content to emphasize the main key take a ways from this documentation document. Use ASCII art diagrams or mermaid diagrams or similar which you can generate. This should convey high level topics not technical details in a beautiful and easy to understand way.

### Document file to re-work:
- added after command

### Pointers to some relevant files: (but look for more)  
- optionally added after command



# What makes documentation good

From [OpenAI Cookbook](https://github.com/openai/openai-cookbook/blob/main/articles/what_makes_documentation_good.md)
